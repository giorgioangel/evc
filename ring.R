...
wd <- getwd()
file_path <- paste("ring/traj/traj_", as.character(traj_number), "_", as.character(trial), ".csv", sep="")
...
folder_output <- file.path('ring', 'posteriors', paste(as.character(traj_number), as.character(trial), sep="_"))
